...
Client.prototype.enableParseMiddleware = function(middleware) {
    if (middleware && typeof middleware === 'function') {
        this._parseMiddlewares.push(middleware);
    }
};

Client.prototype.disableParseMiddleware = function(middleware) {
    if (middlware && typeof middleware === 'function') {
        this._parseMiddlewares = this.parseMiddlewares.filter(function(func) {
...
Client.prototype.parseMessage = function(line) {
    var self = this;
    this._parseMiddlewares.forEach(function(middleware) {
        line = middleware.call(self, line);
    });
